...
import asyncio
import json
from services.timescaledb_connector.timescaledb_connector.config import IN_TOPIC_NAME, GROUP_ID, KAFKA_BROKER, MAX_BUFFER
from services.timescaledb_connector.timescaledb_connector.logging_setup import logger
